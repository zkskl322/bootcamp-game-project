...
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(const Offset(550, 0), const Offset(550, 700), paintLine); // 중앙선
    canvas.drawCircle(const Offset(550, 350), 90, paintLine); // 중앙원
    canvas.drawCircle(const Offset(550, 350), 2, paintLine); // 중앙원 중심

    canvas.drawLine(const Offset(0, 0), const Offset(0, 700), paintLine); // 왼쪽 선
    canvas.drawLine(const Offset(1100, 0), const Offset(1100, 700), paintLine); // 오른쪽 선
    canvas.drawLine(const Offset(0, 0), const Offset(1100, 0), paintLine); // 위쪽 선
    canvas.drawLine(const Offset(0, 700), const Offset(1100, 700), paintLine); // 아래쪽 선


    canvas.drawLine(const Offset(0, 0), const Offset(0, 300), paintLine); // 왼쪽 상단 선
    canvas.drawLine(const Offset(0, 400), const Offset(0, 700), paintLine); // 왼쪽 하단 선
    canvas.drawLine(const Offset(1100, 0), const Offset(1100, 300), paintLine); // 오른쪽 상단 선
    canvas.drawLine(const Offset(1100, 400), const Offset(1100, 700), paintLine); // 오른쪽 하단 선
    
    canvas.drawLine(const Offset(0, 300), const Offset(0, 400), paintGoalline); // 골대
    canvas.drawLine(const Offset(1100, 300), const Offset(1100, 400), paintGoalline); // 골대
